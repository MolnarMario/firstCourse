...
$(document).ready(function () {
	...
	$("#gitHubSearchFrom").on("submit", function () {

		var searchPhrase = $("#searchPhrase").val();
		var useStars = $("#useStars").val();
		var langChoise = $("#langChoise").val();
		...
		if (searchPhrase) {
			...
			if (langChoise != "All") {
				gitHubSearch += "+language:" + encodeURIComponent(langChoise);
			}
	...
	function displayResutls(results) {
		resultList.empty();
	...
	//
	// var aNumber = 10;
	// console.log("none is " + typeof (aNumber));
	//
	// var trueFalse = true;
